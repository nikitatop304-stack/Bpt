...
TELEGRAM_BOT_TOKEN = os.getenv('7831575649:AAH57uaUdPdEq5V5_fwDWARGVjmfXRLLMW4')
API_ID = os.getenv('34000428')
API_HASH = os.getenv('68c4db995c26cda0187e723168cc6285')

# СЕССИЯ
SESSION_FILE = os.getenv('SESSION_FILE')
SESSION_STRING = os.getenv('')
